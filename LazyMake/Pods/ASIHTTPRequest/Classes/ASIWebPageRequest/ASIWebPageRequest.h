...
typedef enum _ASIURLReplacementMode {
	...
	// You must set the baseURL of a WebView / to a file url pointing at the downloadDestinationPath of the main ASIWebPageRequest if you want to display your content
