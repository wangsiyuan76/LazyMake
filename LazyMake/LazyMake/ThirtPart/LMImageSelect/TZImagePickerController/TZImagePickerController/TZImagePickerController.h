...
/// 是否不用TZ的裁剪
@property (nonatomic, assign) BOOL ifUsedTZCrop;
@property (nonatomic, assign) CGSize customAspectRatio;     //裁剪比例 如1：1
@property (nonatomic, copy) void (^noTZCropBlock)(UIImage *cropImage);
